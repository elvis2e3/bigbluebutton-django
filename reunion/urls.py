...
from reunion.views import IndexView, LoginView, PanelView, CrearReunionView, LogoutView, UnirmeView, ReunionLibreView, \
    ...
    CrearReunionSalaView, ListaReunionesActivasView
...
urlpatterns = [
    ...
    path('panel/reuniones_activas', ListaReunionesActivasView.as_view(), name='reuniones_activas'),
    # =========== Directores ======================
    ...
    path('panel/lista_miembros_entidad/<pk>/', ListaMiembrosEntidadView.as_view(), name='lista_miembros_entidad'),
]
